...
public class AssassinCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(args.length == 0 || args[0].equalsIgnoreCase("help")) {
            ...
            p.sendMessage(ChatColor.GREEN + "You have requested an assassin contract with " + target.getDisplayName() + " for " + ChatColor.YELLOW + economy.format(val) + ".");
            target.sendMessage(target.getDisplayName() + ChatColor.GREEN + " has requested an assassin contract worth " + ChatColor.YELLOW + economy.format(val) + ".");
            Main.logger.log("User " + p.getName() + " requested assassin work from " + p.getName() + ", value " + val);
        }
            ...
            Main.logger.log("User " + p.getName() + " accepted assassin work for " + target.getName());
            return true;
        }
            ...
            Main.logger.log("User " + p.getName() + " declined assassin work for " + target.getName());
            return true;
        }
            ...
            Main.DataManager.editData(target.getUniqueId(), "AssassinPermission", true);
            ...
            Main.logger.log("User " + p.getName() + " gave " + target.getName() + " assassin permissions");
        }
            ...
            Main.DataManager.editData(target.getUniqueId(), "AssassinPermission", false);
            ...
            Main.logger.log("User " + p.getName() + " removed " + target.getName() + "'s assassin permissions");
        }
            ...
            Main.logger.log("User " + p.getName() + " completed " + target.getName() + "'s assassin contract.");
        }
        else {
