...
import me.ShermansWorld.AlathraExtras.book.UnwritableBookClickListener;
...
public class AlathraExtras extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.getServer().getPluginManager().registerEvents(new UnwritableBookClickListener(), this);
